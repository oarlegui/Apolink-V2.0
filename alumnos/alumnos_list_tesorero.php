<?php
// archivo: alumnos_list_tesorero.php 
...
$alumno_id = $_POST['alumno_id'] ?? null; // Usar el alumno seleccionado en la sesi贸n
...
$logo_apolink = "https://arlegui-it.cl/apolink/apolink_v2/ApolinkV2/include/img/logo_apolink_tejido1.png";
...
if (!in_array($rol, ['admin', 'admin_curso', 'tesorero', 'apoderado'])) {
    ...
    <body>
        <div class="alert-container">
            <!-- Logo de Apolink -->
            <img src="https://arlegui-it.cl/apolink/apolink_v2/ApolinkV2/include/img/logo_apolink_tejido1.png" alt="Apolink Logo" class="apolink-logo">
 ...
 <style>
    @media print {
        ...
        .apolink-watermark-print img {
            ...
            max-height: 80vh;
            opacity: 0.08;
           /* filter: grayscale(1) drop-shadow(0 0 8px #88888833);*/
            margin: auto;
        ...
        /* Forzar repetición header/footer en cada hoja */
        thead { display: table-header-group; }
        tfoot { display: table-footer-group; }
    }
    .apolink-watermark-print, .apolink-watermark-print img {
        display: none;
    }
</style>
<body>
        ...
        <div class="container mt-4">
            <div class="d-flex justify-content-between align-items-center mb-3">
               <!-- <h4>Lista de Alumnos del Curso - <?= $curso_nombre ?> </h4>-->
                ...
                <button class="btn btn-outline-secondary" onclick="printAlumnos()">Imprimir Lista</button>
            </div>
            ...
            <div class="apolink-watermark-print">
                <img src="<?= $logo_apolink ?>" alt="Logo Apolink marca de agua">
                
            </div>
             <div class="print-header-print">
             <!--   <h3><?= $colegio_nombre ?></h3>
                <h4>Curso: <?= $curso_nombre ?></h4>
                <div>Fecha de impresión: <?= $fecha_impresion ?></div>-->
            </div>
            <div class="printable-table">
                <table class="table table-bordered table-hover">
                    <thead>
                        <tr>
                            <th colspan="<?= in_array($rol, ['admin', 'admin_curso']) ? '8' : '7' ?>" style="text-align:center; font-size: 13px; background:#f7f7f7;">
                                <?= $colegio_nombre ?> - Lista de Curso del <?= $curso_nombre ?> - Fecha de impresión: <?= $fecha_impresion ?>
                            </th>
                        </tr>
                        <tr>
                            <th>Rut</th>
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="<?= in_array($rol, ['admin', 'admin_curso']) ? '8' : '7' ?>" style="text-align:center; font-size: 13px; background:#f7f7f7;">
                                www.apolink.cl
                            </td>
                        </tr>
                    </tfoot>
