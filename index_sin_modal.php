...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($colegio_id)) {
        $error = "Por favor selecciona un colegio válido.";
    } else {
...
// Palabras especiales con estilos personalizados
...
<body>
  <!-- Fondo con filas de palabras motivadoras -->
  ...
  <div class="container login-box">
    <div class="card shadow-lg">
      ...
      <div class="card-header">
        <img src="/sistema-gestion-curso/includes/assets/images/logo_white.png" alt="Logo" style="max-height: 60px;" class="mb-2">
      ...
      <div class="card-footer text-center text-muted small">
        ¿Problemas para ingresar? Contacte al administrador del colegio.
        <div class="mt-3">
